...
TPolicyPackageAlgorithms = TypeVar('TPolicyPackageAlgorithms', bound='PolicyPackageAlgorithms')
...
class PolicyPackageAlgorithms():
    ...
    @classmethod
    def _get_one_algorithm(cls: Type[TPolicyPackageAlgorithms], algorithm_type: str, name: str) -> Callable[..., Any]:
        """
    ...
    @classmethod
    def _get_algorithms(cls: Type[TPolicyPackageAlgorithms], algorithm_type: str) -> Dict[str, Callable[..., Any]]:
        """
    ...
    @classmethod
    def _register(cls: Type[TPolicyPackageAlgorithms], algorithm_type: str, algorithm_dict: Dict[str, Callable[..., Any]]) -> None:
        """
    ...
    @classmethod
    def _supports(cls: Type[TPolicyPackageAlgorithms], algorithm_type: str, name: str) -> bool:
        """
    ...
    @classmethod
    def _register_all_policy_package_algorithms(cls: Type[TPolicyPackageAlgorithms]) -> None:
        '''
    ...
    @classmethod
    def _try_importing_policy(cls: Type[TPolicyPackageAlgorithms], vo: str = "") -> None:
        try:
